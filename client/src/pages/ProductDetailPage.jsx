...
//               <div
//                 key={i}
//                 className={`h-5 shimmer rounded w-${w === 100 ? "full" : `[${w}%]`}`}
//               />
//             ))}
//           </div>
//         </div>
...
//           <h2 className="font-cormorant text-2xl" style={{ color: "#e2e8f0" }}>
//             Product not found
//           </h2>
//         </div>
//       </div>
...
//         {/* ── Breadcrumb ── */}
//         <div
//           className="flex items-center gap-2 mb-8 font-dm text-xs"
//           style={{ color: "#475569" }}
//         >
//           <span
//             className="cursor-pointer hover:text-g-400 transition-colors"
//             onClick={() => navigate("/")}
//           >
//             Home
//           </span>
...
//               {disc > 0 && (
//                 <div
//                   className="absolute top-4 left-4 font-dm text-xs font-bold px-3 py-1 rounded-full text-white"
...
//               {product.isGiftable && (
//                 <div
//                   className="absolute top-4 right-4 font-dm text-xs font-semibold px-3 py-1 rounded-full"
//                   style={{
...
//             {/* Category */}
//             <p
//               className="font-dm text-xs font-semibold uppercase tracking-widest mb-2"
//               style={{ color: "#16a34a" }}
//             >
...
//             {/* Name */}
//             <h1
//               className="font-cormorant text-3xl sm:text-4xl font-semibold leading-tight mb-1"
//               style={{ color: "#e2e8f0" }}
//             >
//               {product.name}
//             </h1>
...
//               <span className="font-dm text-sm" style={{ color: "#4ade80" }}>
...
//                   <>
//                     <span
//                       className="font-dm text-lg line-through pb-1"
//                       style={{ color: "#334155" }}
//                     >
//                       ₹{product.originalPrice?.toLocaleString()}
//                     </span>
//                     <span
//                       className="font-dm text-sm font-semibold pb-1"
//                       style={{ color: "#4ade80" }}
//                     >
//                       Save ₹
...
//                 style={{ color: product.stock > 0 ? "#4ade80" : "#ef4444" }}
//               >
//                 {product.stock > 10
//                   ? "In Stock"
//                   : product.stock > 0
...
//                 <span className="font-dm text-sm" style={{ color: "#64748b" }}>
//                   Quantity
//                 </span>
//                 <div
...
//                     className="w-10 h-10 flex items-center justify-center font-dm text-lg transition-colors"
//                     style={{
//                       color: "#94a3b8",
...
//                   </button>
//                   <span
//                     className="w-12 text-center font-dm text-sm font-semibold"
//                     style={{ color: "#e2e8f0" }}
//                   >
//                     {quantity}
//                   </span>
...
//                 className="flex-1 py-3.5 rounded-xl font-dm font-semibold text-sm text-white transition-all disabled:opacity-50"
//                 style={{ background: "#16a34a" }}
//                 onMouseEnter={(e) =>
//                   !addingCart && (e.currentTarget.style.opacity = "0.9")
//                 }
...
//                 className="flex-1 py-3.5 rounded-xl font-dm font-semibold text-sm transition-all disabled:opacity-50"
//                 style={{
...
//                 className="px-5 py-2.5 rounded-lg font-dm text-sm font-medium capitalize transition-all"
//                 style={{
...
//             <div
//               className="p-6 rounded-2xl font-dm text-sm leading-relaxed"
//               style={{
//                 background: "#162032",
//                 border: "1px solid rgba(255,255,255,0.05)",
//                 color: "#94a3b8",
...
//                       >
//                         <span
//                           className="font-dm text-xs capitalize"
//                           style={{ color: "#475569" }}
//                         >
//                           {key}
//                         </span>
